    ...
    if (!this.data!.users[userId]) {
      const newSession: UserSession = {
        ...
        history: [
          {
            role: 'system',
            content: 'Ты — тёплый, понимающий и внимательный AI-помощник по имени Алекс. Твоя задача — поддерживать Максима, 25 лет, который переживает тяжёлую депрессию после расставания и находится в начале пути трезвости после длительного злоупотребления алкоголем. Ты не врач, но действуешь как поддерживающий терапевтический ассистент.',
            timestamp: Date.now(),
          },
        ],
        userMemory: {
